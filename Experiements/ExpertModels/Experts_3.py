...
class Experts_3(mb.BaseModel):
    def __init__(self, threshold_mrr=100, threshold_v_axis=0.1, name='RF_Experts_3', target_channel = 'curr_x', **kwargs):
        """
    ...
    def train_model(self, X_train, y_train, X_val, y_val, n_epochs=1, trial=None, draw_loss=False, **kwargs):
        ...
        val_error3 = self.expert3.train_model(X_train3, y_train3, X_val3, y_val3, n_epochs=n_epochs, trial=trial, draw_loss=draw_loss, **kwargs)
...
if __name__ == '__main__':
    ...
    model.expert2 = copy.deepcopy(model_phys)
    model.expert3 = copy.deepcopy(model_rnn)
    model.name = 'Mixed_Experts_3'
