...
if __name__ == '__main__':
    ...
    for idx, penelty in enumerate(peneltys):
        model = mnn.PiRNNThermo(learning_rate= 0.09216483876701392, n_hidden_size= 104, n_hidden_layers= 1,
                        activation= 'ReLU', optimizer_type= 'quasi_newton', name = f"PiNN_Thermo_{idx}", penalty_weight=penelty)
        models.append(model)
