    ...
    for material in materials:
        ...
        for geometry in geometries:
            ...
            for model in models:
                ...
                plot_time_series(df, f'{name} {mat} {geometry}:\nStromverlauf der Vorschubachse in x-Richtung',
                                 f'Verlauf_{material}_{geometry}_{model[2]}',
                                 col_name='curr_x', label='Strom in A', dpi=600,
                                 ycolname_1=model[0], ylabel_1='Referenzdaten',
                                 ycolname_2=model[1], ylabel_2='Optimierte Daten')
