...
class BasePlotter(ABC):
    ...
    def replace_space(text):
        ...
        #ergebnis = ergebnis.replace('Recurrent', 'Rekurrentes')
        #ergebnis = ergebnis.replace('Neural', 'neuronales')
        #ergebnis = ergebnis.replace('Net', 'Netz')
...
if __name__ == '__main__':
    ...
    model_prefixes = [
        'ST_Plate_Notch_PiNN_Thermo_0',
        'ST_Plate_Notch_PiNN_Thermo_1',
        'ST_Plate_Notch_PiNN_Thermo_2',
        'ST_Plate_Notch_PiNN_Thermo_3',
        'ST_Plate_Notch_PiNN_Thermo_4'
    ]
    new_names ={
        'ST_Plate_Notch_PiNN_Thermo_0': 'PiNN\nλ=0,01',
        'ST_Plate_Notch_PiNN_Thermo_1': 'PiNN\nλ=0,1',
        'ST_Plate_Notch_PiNN_Thermo_2': 'PiNN\nλ=1',
        'ST_Plate_Notch_PiNN_Thermo_3': 'PiNN\nλ=10',
        'ST_Plate_Notch_PiNN_Thermo_4': 'PiNN\nλ=100'
    }
    ...
    for file in os.listdir('Predictions'):
        if file.endswith('.csv'):
            ...
            mae_std_df = calculate_mae_and_std(df, file, model_prefixes=model_prefixes)
