...
if __name__ == "__main__":
    ...
    model_hybrid_rnn = mnn.HybridModelResidual(physical_model=model_phys, ml_model=model_rnn, name = 'Hybrid Erd Rekurrentes neuronales Netz')
    model_hybrid_rf = mnn.HybridModelResidual(physical_model=model_phys, ml_model=model_rf, name = 'Hybrid Erd Random Forest')
