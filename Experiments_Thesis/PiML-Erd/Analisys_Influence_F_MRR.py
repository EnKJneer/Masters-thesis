...
class CorrelationPlotter:
    ...
    def __init__(self, output_dir="Plot_Correlation"):
    ...
    def plot_correlation(self, df, column1, column2, output_filename=None):
        ...
        # Regressionslinie hinzufügen (nur bei signifikanter Korrelation)
        if abs(correlation) > 0.1 and len(df_filtered) > 20:
            sns.regplot(
                data=df_filtered,
                x=column1,
                y=column2,
