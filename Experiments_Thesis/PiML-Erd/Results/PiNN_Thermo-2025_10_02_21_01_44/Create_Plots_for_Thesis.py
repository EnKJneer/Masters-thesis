...
if __name__ == '__main__':
    ...
    model_prefixes = [
        ...
        'ST_Plate_Notch_PiNN_0.01',
        'ST_Plate_Notch_PiNN_1',
        'ST_Plate_Notch_PiNN_100'
    ]
    new_names ={
        'ST_Plate_Notch_Recurrent_Neural_Net': 'RNN',
        'ST_Plate_Notch_PiNN_0.01': 'PiNN\nλ=0,01',
        'ST_Plate_Notch_PiNN_1': 'PiNN\nλ=1',
        'ST_Plate_Notch_PiNN_100': 'PiNN\nλ=100'
    }
