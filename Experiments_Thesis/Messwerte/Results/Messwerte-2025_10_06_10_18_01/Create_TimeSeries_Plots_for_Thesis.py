...
if __name__ == '__main__':
    ...
    if use_rf:
        model_prefixes = [
            ...
            'ST_Plate_Notch_Measurements_Random_Forest'
        ]
        new_names ={
            'ST_Plate_Notch_Random_Forest': 'Random Forest\nmit Simulationsdaten',
            'ST_Plate_Notch_Measurements_Random_Forest': 'Random Forest\nmit Messwerten'
        }
        path_postfix = '_RF'
    else:
        model_prefixes = [
        ...
        new_names ={
            'ST_Plate_Notch_Recurrent_Neural_Net': 'RNN\nmit Simulationsdaten',
    ...
    for material in materials:
        ...
        for geometry in geometries:
            ...
            plot_time_series(df, f'{mat} {geometry}: Stromverlauf der Vorschubachse in x-Richtung',
                             ...
                             ycolname_1=model_prefixes[0], ylabel_1=new_names[model_prefixes[0]],
                             ycolname_2=model_prefixes[1], ylabel_2=new_names[model_prefixes[1]])
