...
def plot_time_series(data, title, filename, dpi=300, col_name='v_x',
                     ...
                     ycolname_2='Abweichung RNN', ylabel_2 = 'Abweichung RF', f_a=50, path='Plots_Thesis'):
    """
...
if __name__ == '__main__':
    ...
    if use_rf:
        ...
        y_configs = [
            {
                'ycolname': 'ST_Plate_Notch_Random_Forest',
                'ylabel': 'mit simulierten Kräften'
            },
            {
                'ycolname': 'ST_Plate_Notch_Measurements_Random_Forest',
                'ylabel': 'mit Messwerten'
            },
        ]
    else:
        y_configs = [
            ...
            {
                'ycolname': 'ST_Plate_Notch_Measurements_Recurrent_Neural_Net',
                'ylabel': 'mit Messwerten'
            },
        ]
        path_postfix = '_RNN'
    ...
    for material in materials:
        ...
        for geometry in geometries:
            ...
            hplottime.plot_time_series_with_sections(df, f'{mat} {geometry}:\nStromverlauf der Vorschubachse in x-Richtung',
                             f'Verlauf_{material}_{geometry}'+path_postfix,
                             col_name='curr_x', dpi=600, path='Plots_Thesis',
                             y_configs=y_configs,
                                fontsize_axis=16, fontsize_axis_label=16,
                                           fontsize_title=20,)
