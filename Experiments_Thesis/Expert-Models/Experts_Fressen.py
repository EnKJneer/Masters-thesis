...
if __name__ == '__main__':
    ...
    dataSet.testing_data_paths = ['DMC60H_AL2007T4_Gear_Depth_3.csv', 'DMC60H_AL2007T4_Plate_Normal_3.csv',
                      'DMC60H_S235JR_Gear_Normal_3.csv', 'DMC60H_S235JR_Plate_Normal_3.csv']
    ...
    hexp.run_experiment(dataClasses, models=models,
                        ...
                        plot_types=['heatmap', 'model_heatmap', 'prediction_overview'], experiment_name=model.name+'_Fressen_'+axis)
