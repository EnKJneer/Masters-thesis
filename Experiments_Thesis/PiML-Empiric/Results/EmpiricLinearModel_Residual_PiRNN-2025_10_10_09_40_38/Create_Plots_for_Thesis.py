...
if __name__ == '__main__':
    ...
    model_prefixes = [
        'ST_Plate_Notch_EmpiricLinearModel',
        'ST_Plate_Notch_PiRNN',
        'ST_Plate_Notch_Hybrid_PiRNN'
    ]
    new_names ={
        'ST_Plate_Notch_EmpiricLinearModel': 'Empirisches Modell',
        'ST_Plate_Notch_PiRNN': 'PiRNN',
        'ST_Plate_Notch_Hybrid_PiRNN': 'Residual-Modell',
    }
