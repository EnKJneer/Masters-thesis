...
if __name__ == '__main__':
    ...
    model_prefixes = [
        'ST_Plate_Notch_Friction_Model',
        'ST_Plate_Notch_Random_Forest',
        'ST_Plate_Notch_Hybrid_Random_Forest'
    ]
    new_names ={
        'ST_Plate_Notch_Friction_Model': 'Empirisches Modell',
        'ST_Plate_Notch_Random_Forest': 'Random Forest',
        'ST_Plate_Notch_Hybrid_Random_Forest': 'Residual-Modell',
    }
