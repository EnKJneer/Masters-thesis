...
if __name__ == '__main__':
    ...
    new_names ={
        'ST_Plate_Notch_EmpiricLinearModel': f'\nEmpirisches-Modell {AXIS}-Achse',
    }
    ...
    plot_paths = plotter.create_plots(df=combined_mae_std_df, new_names=new_names, title='Empirisches Modell')
