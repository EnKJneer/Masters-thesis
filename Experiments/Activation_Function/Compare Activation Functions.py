...
if __name__ == "__main__":
    ...
    models = [model_nn, model_nn_ELU, model_nn_PReLU, model_nn_Tanh]
        ...
        model_info = {
            model.name+"_Ensemble": {
                ...
                "hyperparameters": {
                    ...
                    "n_hidden_size": model.n_hidden_size,
                    "n_hidden_layers": model.n_hidden_layers,
                    "n_activation_function": model.name,
                }
            },
        }
    ...
    for i,data in enumerate(dataSets):
        ...
        # Modellvergleich auf neuen Daten
            ...
            df[model.name] = np.mean(nn_preds, axis=0)
    ...
    ax.set_title(f"Vergleich Aktivierungsfunktionen")
