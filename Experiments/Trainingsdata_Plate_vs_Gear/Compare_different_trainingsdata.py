...
Al_Al_Gear_Plate = hdata.DataclassCombinedTrainVal('Al_Al_Gear_Plate', fgearer_data,
                                                   ['AL_2007_T4_Gear', 'AL_2007_T4_Gear_Depth', 'AL_2007_T4_Gear_SF'],
                                                   ['AL_2007_T4_Plate_Normal_3.csv'],
                                                   ["curr_x"], 100, )
Al_St_Gear_Gear = hdata.DataclassCombinedTrainVal('Al_St_Gear_Gear', fgearer_data,
                                                  ['AL_2007_T4_Gear', 'AL_2007_T4_Gear_Depth', 'AL_2007_T4_Gear_SF'],
                                                  ['S235JR_Gear_Normal_3.csv'],
                                                  ["curr_x"], 100, )
Al_St_Gear_Plate = hdata.DataclassCombinedTrainVal('Al_St_Gear_Plate', fgearer_data,
                                                   ['AL_2007_T4_Gear', 'AL_2007_T4_Gear_Depth', 'AL_2007_T4_Gear_SF'],
                                                   ['S235JR_Plate_Normal_3.csv'],
                                                   ["curr_x"], 100, )
dataSets_list_Gear = [Al_Al_Gear_Plate,Al_St_Gear_Gear,Al_St_Gear_Plate]

Al_Al_Plate_Gear = hdata.DataclassCombinedTrainVal('Al_Al_Plate_Gear', fgearer_data,
                                                   ['AL_2007_T4_Plate', 'AL_2007_T4_Plate_Depth', 'AL_2007_T4_Plate_SF'],
                                                   ['AL_2007_T4_Gear_Normal_3.csv'],
                                                   ["curr_x"], 100, )
Al_St_Plate_Plate = hdata.DataclassCombinedTrainVal('Al_St_Plate_Plate', fgearer_data,
                                                    ['AL_2007_T4_Plate', 'AL_2007_T4_Plate_Depth', 'AL_2007_T4_Plate_SF'],
                                                    ['S235JR_Plate_Normal_3.csv'],
                                                    ["curr_x"], 100, )
Al_St_Plate_Gear = hdata.DataclassCombinedTrainVal('Al_St_Plate_Gear', fgearer_data,
                                                   ['AL_2007_T4_Plate', 'AL_2007_T4_Plate_Depth', 'AL_2007_T4_Plate_SF'],
                                                   ['S235JR_Gear_Normal_3.csv'],
                                                   ["curr_x"], 100, )
