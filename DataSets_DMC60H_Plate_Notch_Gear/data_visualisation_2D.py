...
for file in files:
    ...
    '''    plot_time_series(data, name, label='curr_x', dpi=300, ylabel='f_x_sim', align=False)
    plot_time_series(data, name, label='curr_x', dpi=300, ylabel='f_x', align=False)
    plot_time_series(data, name, label='f_x', dpi=300, ylabel='f_x_sim', align=True)
    plot_time_series(data, name, label='v_x', dpi=300, ylabel='f_x_sim', align=True)
    plot_time_series(data, name, label='v_x', dpi=300, ylabel=None, align=None)
